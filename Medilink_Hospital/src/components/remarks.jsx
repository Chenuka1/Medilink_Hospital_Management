    ...
    return (
        <div className="remarks-container">
            ...
            <div className='patient-details'>
                ...
                <p><strong>Age:</strong> {calculateAge(patientdetail.MPD_birthdate)}</p>
            ...
            <div className="button-container no-print">
                ...
                <button onClick={downloadInvoice} className="btn download-btn">Download</button>
                <button onClick={handleViewInvoice} className='btn Invoice-btn'>Invoice</button>
            </div>
        </div>
    );
}
